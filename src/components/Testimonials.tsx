...
const transportTestimonials = [
  ...
  },
  {
    ...
    text: "O pessoal foca muito em quem está na região de São Paulo. Os clientes já chegam sabendo o que querem, só me perguntam os horários disponíveis e fecham a locação.",
    rating: 5
  },
  {
    name: "Carlos",
